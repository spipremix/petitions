...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'form_pet_envoi_mail_confirmation' => 'که‌میو ته‌ر دڵنیایی که‌رۆ چه‌ په‌یامیڤی که‌ پێکیانیان. پێ دڵنیابیه‌ی چه‌ واژووکه‌یت پیویستا سه‌ردانی ئا به‌سته‌رییه‌ چا په‌یامه‌نه‌ که‌ری.',
