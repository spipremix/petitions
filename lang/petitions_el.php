...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// F
	'filtre' => 'Filtre :', # NEW
	'form_pet_adresse_site' => 'Το URL της ιστοσελίδα σας',
	...
	'form_pet_envoi_mail_confirmation' => '<MODIF>Ενα mail επιβεβαίωσης έχει αποσταλεί σε @email@. Πρέπει να επισκεφτείτε τη διεύθυνση Web που αναφέρεται σε αυτό για να επικυρώσετε την εγγραφή σας.',
...
',
	...
	'form_pet_votre_nom' => 'Ονομα ή ψευδώνυμο',
