...
### - Fichier d'origine : ../plugins/auto/petitions/plugin.xml
...
# svn add lang/paquet-petitions_fr.php
...
# svn mv base/petitions_upgrade.php petitions_administrations.php
# svn mv public/petitions.php petitions_fonctions.php
